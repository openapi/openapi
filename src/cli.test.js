...
test("simple v2 [json, code]", () => {
  execSync(
    "node ./src/cli.js --file ./src/mocks/petstore-v2.json --output-dir ./TEST_API",
  );
  const code = readFileSync("./TEST_API/index.js", "utf8");
...
test("simple v2 [json, types]", () => {
  execSync(
    "node ./src/cli.js --file ./src/mocks/petstore-v2.json --output-dir ./TEST_API",
  );
  const types = readFileSync("./TEST_API/index.d.ts", "utf8");
...
test("simple v2 [yaml, code]", () => {
  execSync(
    "node ./src/cli.js --file ./src/mocks/petstore-v2.yaml --output-dir ./TEST_API",
  );
  const code = readFileSync("./TEST_API/index.js", "utf8");
...
test("simple v3 [json, code]", () => {
  execSync(
    "node ./src/cli.js --file ./src/mocks/petstore-v3.json --output-dir ./TEST_API",
  );
  const types = readFileSync("./TEST_API/index.d.ts", "utf8");
...
test("multi-file ref url v2 [yaml, code]", () => {
  execSync(
    "node ./src/cli.js --file ./src/mocks/petstore-v2.yaml --output-dir ./TEST_API",
  );
  const code = readFileSync("./TEST_API/index.js", "utf8");
...
test("multi-file ref url v2 [yaml, types]", () => {
  execSync(
    "node ./src/cli.js --file ./src/mocks/petstore-v2.yaml --output-dir ./TEST_API",
  );
  const types = readFileSync("./TEST_API/index.d.ts", "utf8");
